...
<div class="pagecontents">
  <table border=0 width=100% height=80%>
    <tr>
      <td align=center height=10% colspan=3><div class="pagetitle">Create A New Event</div><hr class="style-one"></td>
    </tr>
    <tr>
...
<table>
  ...
  <td align=center height=50% colspan=3>
        <div id="form", style="width:100%; height:100%">
          <fieldset>
            <legend style="color:black;font-weight:bold;">Special Notes</legend>
              <table border=0 width=100%>
                <tr>
                  <td><textarea rows="4" cols="50" name=specNotes form=usrfrom style="width:100%;">Enter text here...."</textarea>
                </tr>
              </table>
          </fieldset>
        </div>
